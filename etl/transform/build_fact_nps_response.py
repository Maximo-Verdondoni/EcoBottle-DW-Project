...
import pandas as pd
def build_fact_nps_response(data,dim_customer,dim_channel, output_path):
    """
    ...
    fact_nps_response['responded_at_date'] = fact_nps_response['responded_at'].dt.date
    ...
    fact_nps_response = fact_nps_response[[
        ...
        'responded_at_date', 'responded_at_time'
    ]]
