...
def run_pipeline():
    ...
    df_fact_sales_order_item = build_fact_sales_order_item(data, df_dim_calendar,df_dim_customer, df_dim_channel,df_dim_address,df_dim_store, df_dim_product, OUTPUT_PATH)
